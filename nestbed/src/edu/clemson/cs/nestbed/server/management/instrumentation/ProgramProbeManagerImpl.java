...
public class ProgramProbeManagerImpl extends    UnicastRemoteObject
                                     implements ProgramProbeManager {

    private final static ProgramProbeManagerImpl instance;

    private final static Log log = LogFactory.getLog(
                                           ProgramProbeManagerImpl.class);
    ...
    public Map<Integer, List<TraceData>> collectData(List<MoteTestbedAssignment> interestingMotes)
        ...
        for (MoteTestbedAssignment mta : interestingMotes) {
            try {
                ...
                synchronized(listener) { try { listener.wait(); } catch (Exception ex) { } }
    ...
    public void insertProbes(int programID, Map<String, List<String>> moduleIncludeMap) throws RemoteException {
        ...
        try {
            ...
            gccArgs.add("-I"); gccArgs.add(NESTBED_NESC_ROOT + "/TraceRecorder");
            gccArgs.add("-I"); gccArgs.add(NESTBED_NESC_ROOT + "/ModifiedTinyOS");
            gccArgs.add("-I"); gccArgs.add(NESTBED_NESC_ROOT + "/MemoryProfiler");
            gccArgs.add("-I"); gccArgs.add(NESTBED_NESC_ROOT + "/NestbedControl");
            ...
            traceInstrumentor = new TraceInstrumentor(prependList, appendList, gccArgs, topLevelFile.getAbsolutePath(),
                                                      analysisDir);
    ...
    private StaticProgramData readStaticData(File file) throws IOException,
