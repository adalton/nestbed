/* $Id$ */
/*
 * MoteTestbedAssignmentManager.java
 *
...
public interface MoteTestbedAssignmentManager extends Remote {
    public List<MoteTestbedAssignment>
            getMoteTestbedAssignmentList(int testbedID) throws RemoteException;
